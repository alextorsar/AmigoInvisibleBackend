...
class GameNotFoundException(DomainException):
    ...
    def __init__(self, game_id_or_code: str):
        super().__init__(f"Secret Santa game with ID or code '{game_id_or_code}' was not found.")
...
class DuplicatePlayerEmailException(DomainException):
    ...
    def __init__(self, email: str):
        super().__init__(f"A player with email '{email}' is already registered in this game.")
